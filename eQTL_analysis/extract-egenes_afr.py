...
# gtex_cutoffs = {}
# egenes = '/share/hennlab/projects/TANDEM_SA/eQTL_final/egenes.txt.gz'
...
global_counts = write_dict(global_ties, outdir+'/gtex.admix.global.egenes.tied_afr.txt.gz')
local_counts = write_dict(local_ties, outdir+'/gtex.admix.local.egenes.tied_afr.txt.gz')
