...
header=header_expressionfile.txt
    ...
    for i in {1..22} ; do
            ...
            do
                    paste ${header} > /mnt/lustre/users/yswart/eQTL/chunks/tmp.chr${i}.txt
                    paste /mnt/lustre/users/yswart/eQTL/chunks/${file} >> /mnt/lustre/users/yswart/eQTL/chunks/tmp.chr${i}.txt
